...
const Blog = () => {
    return (
        <div className="py-10 lg:mx-0 mx-5 blog-style" id="details" style={{ backgroundImage: `url(${background})`, backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
