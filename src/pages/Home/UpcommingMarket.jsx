...
const UpcommingMarket = () => {
  return (
    <section
      className="py-10 lg:px-0 px-5 bg-[#262858] text-white"
      id="partner"
    >
      <div className="max-w-6xl mx-auto">
        <div className="space-y-5 mb-10 lg:w-1/2 mx-auto">
          <Heading heading="Upcomming Market" />
          <Description description="Explore the next big opportunities in the world of finance and technology with our curated list of upcoming markets. Stay ahead of the curve and discover the trends and innovations that are shaping the future." />
        </div>
      </div>
      <div className="pb-10">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-4 md:grid-col md:grid-cols-3 grid-cols-2">
          <div className=" border-b border-r partner-body">
            <Link
              onClick={() =>
                window.open(
                  `https://explorer.bitquery.io/bsc/token/0xa670d686d93e6410317d6648667daf848bbde995`,
                  "_blank"
                )
              }
            >
              <img
                className="img-style"
                src={
                  "https://i.postimg.cc/GhpgNWFP/1684565234110-removebg-preview.png"
                }
                alt=""
              />
            </Link>
          ...
          <div className=" border-b lg:border-r md:border-r partner-body">
            <Link
              onClick={() =>
                window.open(
                  `https://www.geckoterminal.com/bsc/pools/0xd7cdb5c485ffbc2e84187fc3c66f4b6752e64aa3`,
                  "_blank"
                )
              }
            >
              <img
                className="img-style"
                src={
                  "https://i.postimg.cc/65yJR2mN/mexc-global6000-removebg-preview.png"
                }
                alt=""
              />
            </Link>
          ...
          <div className=" border-b border-r md:border-r-0 lg:border-r partner-body">
            <Link
              onClick={() =>
                window.open(
                  `https://coinbrain.com/coins/bnb-0xa670d686d93e6410317d6648667daf848bbde995`,
                  "_blank"
                )
              }
            >
              <img
                className="img-style"
                src={"https://i.postimg.cc/fWgW6N4D/logo-1.png"}
                alt=""
              />
            </Link>
          </div>
          <div className=" border-b lg:border-r-0 md:border-r partner-body">
            ...
            >
              <img
                className="img-style"
                src={
                  "https://i.postimg.cc/c1KMqdKc/lbank2049-removebg-preview.png"
                }
                alt=""
              />
            </Link>
...
export default UpcommingMarket;
